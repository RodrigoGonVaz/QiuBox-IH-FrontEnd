...
export default function Login() {
  ...
  const handleChange = (e) => {
	...
	return (
    <div
        className="bg-scroll bg-rosamx-800"
        style={{
          backgroundImage:
  ...
  <div className="sm:mx-auto sm:w-full sm:max-w-md">
    <div className="bg-white py-8 px-4 shadow-2xl shadow-pink-900 sm:rounded-lg sm:px-10">
      <form 
        className="space-y-6"
  ...
  //                     alt="..."
  //                     className="w-5 mr-1"
  //                     src="https://raw.githubusercontent.com/creativetimofficial/tailwind-starter-kit/main/Login%20Page/react-login-page/src/assets/img/github.svg"
  //                   />
  //                   Github
  //                 </button>
  //                 <button
