...
const CreaArtesania = () => {
  ...
  const {
    createArtesania, // en GuitarState
  } = ctx;

  //console.log(createArtesania);

  //2. Estado Local
  const [newArtesania, setNewArtesania] = useState({
    arteTitle: "",
    // arteUsername: "",
    artePrice: "",
    arteImage: "",
        ...
        <div className="flex justify-center px-6 my-12">
          <div className="w-full xl:w-3/4 lg:w-11/12 flex">
            <div
              ...
              style={{
                backgroundImage:
                  "url(https://storage.googleapis.com/noticiasweb/images/2018/12/Pi%C3%B1ata-en-las-posadas-navide%C3%B1as.jpg)",
              }}
            ></div>
